...
@Controller
@RequestMapping(path="/reyesu/student") // Updated URI
public class MainController {
    ...
    public ResponseEntity createStudent(@RequestBody Student student) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/reyesu/student/" + savedStudent.getId())).body(savedStudent);
    }
